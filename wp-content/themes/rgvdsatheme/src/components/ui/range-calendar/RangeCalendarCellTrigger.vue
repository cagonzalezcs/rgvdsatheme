...
<template>
  <RangeCalendarCellTrigger
    ...
    :class="cn(
      ...
      'h-8 w-8 p-0 font-normal data-[selected]:opacity-100 data-[selected]:text-accent-foreground',
      '[&[data-today]:not([data-selected])]:border-2 [&[data-today]:not([data-selected])]:border-ink',
      // Selection Start
