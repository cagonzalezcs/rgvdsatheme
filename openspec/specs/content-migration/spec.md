...
- **THEN** the retained ACF meta and `_rgvdsa_blocks_migrated` stamps allow reconstructing pre-migration state (git revert restores the ACF serializer) with no data loss
